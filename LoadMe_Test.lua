...
local pf = require "Pathfinder/MoveToApp"  -- loading the module MoveToApp and getting the functions it sends back in a table: PathFinder.
...
function onPathAction()
    map = getAreaName() -- get the map name
		--log(getMapName())
		pf.moveTo(map, "Pokémon Tower 7F")
